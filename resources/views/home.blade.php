          ...
          <div class="row align-items-center">
            ...
            <div class="col">
              <ul class="nav nav-pills justify-content-end">
                <li class="nav-item mr-3 mr-md-0" data-toggle="chart" data-target="#chart-sales"
                ...
                <li class="nav-item" data-toggle="chart" data-target="#chart-sales"
                  data-update='{"data":{"datasets":[{"data":[-1, 20, 5, 25, 10, 30, 15, 40, 40]}]}}' data-prefix="$"
                  data-suffix="k">
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <div class="progress">
                        <div class="progress-bar bg-gradient-danger" role="progressbar" aria-valuenow="59"
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <div class="progress">
                        <div class="progress-bar bg-gradient-success" role="progressbar" aria-valuenow="69"
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <div class="progress">
                        <div class="progress-bar bg-gradient-primary" role="progressbar" aria-valuenow="79"
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <div class="progress">
                        <div class="progress-bar bg-gradient-info" role="progressbar" aria-valuenow="74"
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <div class="progress">
                        <div class="progress-bar bg-gradient-warning" role="progressbar" aria-valuenow="29"
